...
+ (KJLoading*)initWithLoadingAnmationConfiguration:(KJLoadingDeploy*__nullable)configuration{
    ...
    _tools.kConfiguration = configuration == nil ? [KJLoadingDeploy defaultLoadingConfiguration] : configuration;
    return _tools;
}
...
- (void)kLoadingAnimationStartAnimatingWithView:(UIView*)view Configuration:(KJLoadingDeploy *__nullable)configuration{
    self.kConfiguration = configuration == nil ? [KJLoadingDeploy defaultLoadingConfiguration] : configuration;
